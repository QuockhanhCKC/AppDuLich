...
class TuorPage extends StatefulWidget {
  const TuorPage({Key? key}) : super(key: key);

  @override
  _TuorPageState createState() => _TuorPageState();
}

class _TuorPageState extends State<TuorPage> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: FutureBuilder<List<Sites>>(
        future: SitesProvider.fecthSiteLoai('Tour'),
